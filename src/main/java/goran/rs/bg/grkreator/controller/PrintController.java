...
public class PrintController implements Initializable {
	...
	if (document.isInPdvSystem()) {
	    ...
	    gridTable.add(createCell("Koli-" + lineSeparator + "čina", Pos.CENTER, TextAlignment.CENTER,
		    TableStyle.HEADER_MID), 3, 0);
	    ...
	    gridTable.add(createCell("Iznos" + lineSeparator + "PDV", Pos.CENTER, TextAlignment.CENTER,
		    TableStyle.HEADER_MID), 7, 0);
	    gridTable.add(createCell("Ukupna" + lineSeparator + "naknada", Pos.CENTER, TextAlignment.CENTER,
		    TableStyle.HEADER_LAST), 8, 0);
	} else {
	    gridTable.add(createCell("Naziv dobra/usluge", Pos.CENTER, TextAlignment.CENTER, TableStyle.HEADER_MID), 1,
		    0);
	    gridTable.add(createCell("Jm.", Pos.CENTER, TextAlignment.CENTER, TableStyle.HEADER_MID), 2, 0);
	    gridTable.add(createCell("Količina", Pos.CENTER, TextAlignment.CENTER, TableStyle.HEADER_MID), 3, 0);
	    gridTable.add(createCell("Cena", Pos.CENTER, TextAlignment.CENTER, TableStyle.HEADER_MID), 4, 0);
	    gridTable.add(createCell("Ukupna naknada", Pos.CENTER, TextAlignment.CENTER, TableStyle.HEADER_LAST), 5, 0);
	}
    }
...
//				System.err.println("MID ROW");
		...
		if (document.isInPdvSystem()) {
		    gridTable.addRow(i + 1, firstBox,
			    ...
			    createCell(String.format("%,.2f din.", item.getRealPrice()), Pos.CENTER_RIGHT,
